...
Shader "Custom/Gaze"
{
	...
	SubShader
	{
		...
		fixed4 frag(v2f i) : SV_Target
		{
			...
			else if ((user_distance > 1.25f) && (user_distance <= 1.75f)) {
				ret.r = 244 / 255.0f;
				ret.g = 109 / 255.0f;
				ret.b = 67 / 255.0f;
			}
			else if ((user_distance > 1.75f) && (user_distance <= 2.25f)) {
				ret.r = 253 / 255.0f;
				ret.g = 174 / 255.0f;
				ret.b = 97 / 255.0f;
			}
			else if ((user_distance > 2.25f) && (user_distance <= 2.75f)) {
				ret.r = 254 / 255.0f;
				ret.g = 224 / 255.0f;
				ret.b = 144 / 255.0f;
			}
			else if ((user_distance > 2.75f) && (user_distance <= 3.25f)) {
				ret.r = 255 / 255.0f;
				ret.g = 255 / 255.0f;
				ret.b = 191 / 255.0f;
			}
			else if ((user_distance > 3.25f) && (user_distance <= 3.75f)) {
				ret.r = 224 / 255.0f;
				ret.g = 243 / 255.0f;
				ret.b = 248 / 255.0f;
			}
			else if ((user_distance > 3.75f) && (user_distance <= 4.25f)) {
				ret.r = 171 / 255.0f;
				ret.g = 217 / 255.0f;
				ret.b = 233 / 255.0f;
			}
			else if ((user_distance > 4.25f) && (user_distance <= 4.75f)) {
				ret.r = 116 / 255.0f;
				ret.g = 173 / 255.0f;
				ret.b = 209 / 255.0f;
			}
